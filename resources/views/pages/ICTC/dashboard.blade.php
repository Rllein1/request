                    ...
                    <div class="col-md-4 form{{$form->id}}">
                        <div class="m-3 shadow p-3">
                            ...
                            <div class="text-center donebtn">
                                <button class="btn btn-outline-primary" onclick="done({{$form->id}})">DONE</button>
                            </div>
                        </div>
                    </div>
                    @endif
                ...
                <div class="row container text-center pendingbox">
                    ...
                    <div class="col-md-4 form{{$form->id}}">
                        <div class="m-3 shadow p-3">
                            ...
                            <div class="text-center donebtn">
                                <button class="btn btn-outline-primary m-2 accept" onclick="accept({{$form->id}})">ACCEPT</button>
